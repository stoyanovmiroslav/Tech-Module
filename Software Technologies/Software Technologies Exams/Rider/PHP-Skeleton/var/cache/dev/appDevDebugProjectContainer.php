...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' => 'get107aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service',
            '2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' => 'get207aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service',
        ...
        $this->privates = array(
            '1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' => true,
            '2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620']) ? $this->services['1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620'] : $this->get107aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620']) ? $this->services['2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620'] : $this->get207aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_52c23f9e1f4b49d1db44fcf2628fe56bbcc27504461f9efbf303bd5748bae501');
    ...
    /**
     * Gets the '1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get107aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service()
    {
        return $this->services['1_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get207aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620Service()
    {
        return $this->services['2_07aa6a399cfc111cc3c88c5a64215be245db1637f5da0a0b1b0b7a791c084620'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('gn8xD5IEpn', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ieunJT3WbJ', 0, 'AALRR1kh7DG6mSk-x6He-V', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('c2P-QlkoAL', 0, 'AALRR1kh7DG6mSk-x6He-V', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a4ccd85a66978.70827541');
    }
