...
public class ReportController {
	...
	public String createProcess(Model model, ReportBindingModel reportBindingModel, BindingResult bindingResult) {
		...
		Report f = new Report();
		f.setStatus(reportBindingModel.getStatus());
		f.setMessage(reportBindingModel.getMessage());
		f.setOrigin(reportBindingModel.getOrigin());
		reportRepository.saveAndFlush(f);
		return "redirect:/";
	}
